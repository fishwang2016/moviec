...
This version is to extract data information for the last 501 links;
...
def get_movie(url):
    ...
    soup= BeautifulSoup(response.content,from_encoding ="utf8")
...
if  __name__ == "__main__":
    ...
    # conn.close()
    url =(2,"http://www.dytt8.net/html/gndy/dyzz/20140619/45448.html")
    get_movie(url)
